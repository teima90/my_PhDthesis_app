        ...
        navbarPage("Saura-Sanchez, 2020",
                   tabPanel("Informacion",
                            ...
                            div(h3("Que contiene?"),
                              ...
                              de los transcriptomas analizados en el capitulo 5 de esta tesis, asi como descargar los datos asociados.",style="font-size:15px;line-height:25px")),
                   tabPanel("Anexos",
                            h3("Anexos"),
                            br(),
                            downloadLink("anexo_a", strong("Anexo A."))," Capitulo 5: Genes regulados por sombra en el genotipo WT Col-0.",
                            br(),
                            br(),
                            downloadLink("anexo_b", strong("Anexo B."))," Capitulo 5: Analisis de enriquecimiento ontologico.",
                            br(),
                            br(),
                            downloadLink("anexo_c", strong("Anexo C."))," Capitulo 5: Genes regulados por BBX28.",
                            br(),
                            br(),
                            downloadLink("anexo_d", strong("Anexo D."))," Capitulo 5: Genes regulados por BBX28, COP1 y PIF.",
                            br(),
                            br(),
                            downloadLink("anexo_e", strong("Anexo E."))," Capitulo 6: Genes regulados por BBX24 y MeJA.",
                            br(),
                            br(),
